...
function ServicesAnimatedDiv() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://www.omfiresafety.com/assets/img/services/services_1/services_banner.png')",
      }}
    >
      <div
      ...
      >
        <h1 className="text-white text-4xl md:text-6xl font-bold ">SERVICES</h1>
      </div>
    </div>
  );
}

export default ServicesAnimatedDiv;
